...
import 'package:hr_app/widgets/responsabilityAcceptanceDialog.dart';

class ResponsabiltyAcceptanceScreen extends StatefulWidget {
  const ResponsabiltyAcceptanceScreen({super.key});

  @override
  State<ResponsabiltyAcceptanceScreen> createState() =>
      _ResponsabiltyAcceptanceScreenState();
}

class _ResponsabiltyAcceptanceScreenState
    extends State<ResponsabiltyAcceptanceScreen> {
    ...
    return Directionality(
      ...
      child: ListView(children: [
        Padding(
          ...
          child: headLine("استلام عهده للموظف"),
        ),
          ...
          onTap: () {
            showDialog(
              ...
              builder: (BuildContext context) {
                return Directionality(
                    textDirection: TextDirection.rtl,
                    child: ResponsabilityAcceptanceDialog(
                      doc: doc,
                    ));
              },
            );
