...
import 'package:hr_app/widgets/resp_acceptance.dart';

class ResponsabiltyDeliveryScreen extends StatefulWidget {
  const ResponsabiltyDeliveryScreen({super.key});

  @override
  State<ResponsabiltyDeliveryScreen> createState() =>
      _ResponsabiltyDeliveryScreenState();
}

class _ResponsabiltyDeliveryScreenState
    extends State<ResponsabiltyDeliveryScreen> {
    ...
    return Directionality(
      ...
      child: ListView(children: [
        Padding(
          ...
          child: headLine("تسليم عهده للموظف"),
        ),
          ...
          onTap: () {
            showDialog(
              ...
              builder: (BuildContext context) {
                return Directionality(
                    textDirection: TextDirection.rtl,
                    child: ResponsabilityDeliveryDialog(
                      doc: doc,
                    ));
              },
            );
