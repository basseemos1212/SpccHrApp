...
class ResponsabilityDeliveryDialog extends StatefulWidget {
  final dynamic doc;
  const ResponsabilityDeliveryDialog({super.key, this.doc});

  @override
  State<ResponsabilityDeliveryDialog> createState() =>
      _ResponsabilityDeliveryDialogState();
}

class _ResponsabilityDeliveryDialogState
    extends State<ResponsabilityDeliveryDialog> {
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        TextButton(
          ...
          child: const Text(' تسليم العهده للموظف'),
        ),
        TextButton(
          onPressed: () {
